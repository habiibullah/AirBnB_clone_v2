...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new_and_save(self):
        ...
        new_user = User(**{'first_name': 'drakula',
                           'last_name': 'Count',
                           'email': 'drakula@count.com',
                           'password': 12345})
        cur = db.cursor()
    ...
    def test_new(self):
        ...
        self.assertIn('garfield24@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('Garfield', result)
